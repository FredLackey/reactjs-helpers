...
describe('moveDown function', () => {
  // Test case 1: Move an item down within the array
  it('moves an item down within the array', () => {
    const array = ['A', 'B', 'C', 'D'];
    const item = 'B';

    const newArray = moveDown(array, item);

    // Check if the item was moved down correctly
  ...
  // Test case 5: Item is already at the last position
  it('returns the original array when the item is already at the last position', () => {
    const array = ['A', 'B', 'C', 'D'];
    const item = 'D'; // Item is already at the last position
